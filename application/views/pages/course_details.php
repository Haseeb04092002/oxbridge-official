...
$course_data['teacher_image'] = $teacher_image;
$course_data['course_card_image'] = $course_card_image;
$course_data['course_banner_image'] = $course_banner_image;
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-12 m-b30">
                                <div class="course-detail-bx">
                                    ...
                                    <div class="course-buy-now text-center">
                                        <form method="post" action="<?= site_url('Home/enroll'); ?>" target="_blank">
                                            <input type="hidden" name="course_data" value='<?= json_encode($course_data); ?>'>
                                            <button type="submit" class="btn radius-xl text-uppercase">
                                                Enroll Now
                                            </button>
                                        </form>
                                    </div>
